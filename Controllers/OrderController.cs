        ...
        public async Task<IActionResult> Create()
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    var response = await _httpClient.PostAsync("https://st10254797.azurewebsites.net/api/Orders/send?code=yY4FyfQhNxYByYthSIGjJdbvaJAai95evJXJb1cJbYy0AzFuvzSm7w%3D%3D", content);
