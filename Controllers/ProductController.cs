    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create(Product product, IFormFile imageFile)
        {
            ...
            try
            {
                ...
                var response = await httpClient.PostAsync("https://st10254797.azurewebsites.net/api/StoreProduct?code=yY4FyfQhNxYByYthSIGjJdbvaJAai95evJXJb1cJbYy0AzFuvzSm7w%3D%3D", httpContent);
