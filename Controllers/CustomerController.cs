...
namespace ABCRetailApp.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public async Task<IActionResult> StoreCustomer(CustomerProfile customer)
        {
            ...
            var response = await _httpClient.PostAsync("https://st10254797.azurewebsites.net/api/StoreCustomerProfile?code=yY4FyfQhNxYByYthSIGjJdbvaJAai95evJXJb1cJbYy0AzFuvzSm7w%3D%3D", content);
